...
public class SpawnManagerPoolLeft<T> where T : MonoBehaviour
{
    public T prefab { get; }
    ...
    public SpawnManagerPoolLeft(T prefab, int count)
    {
        this.prefab = prefab;
    ...
    public SpawnManagerPoolLeft(T prefab, int count, Transform container)
    {
        this.prefab = prefab;
        this.container = container;
        this.CreatePool(count);
